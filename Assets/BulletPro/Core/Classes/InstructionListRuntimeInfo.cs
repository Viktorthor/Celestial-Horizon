...
namespace BulletPro
{
	...
	public struct InstructionListRuntimeInfo
	{
		...
		InstructionResult DoInstruction(int index)
		{
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customInt = bullet.dynamicSolver.SolveDynamicInt(rawInst.customInt, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customSlider01 = bullet.dynamicSolver.SolveDynamicSlider01(rawInst.customSlider01, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.factor = bullet.dynamicSolver.SolveDynamicFloat(rawInst.factor, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customVector2 = bullet.dynamicSolver.SolveDynamicVector2(rawInst.customVector2, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customVector3 = bullet.dynamicSolver.SolveDynamicVector3(rawInst.customVector3, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customVector4 = bullet.dynamicSolver.SolveDynamicVector4(rawInst.customVector4, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customColor = bullet.dynamicSolver.SolveDynamicColor(rawInst.customColor, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customGradient = bullet.dynamicSolver.SolveDynamicGradient(rawInst.customGradient, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customBool = bullet.dynamicSolver.SolveDynamicBool(rawInst.customBool, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customString = bullet.dynamicSolver.SolveDynamicString(rawInst.customString, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customAnimationCurve = bullet.dynamicSolver.SolveDynamicAnimationCurve(rawInst.customAnimationCurve, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
			...
			{
				if (IsRerollNecessary(ip, 0))
					ip.customObjectReference = bullet.dynamicSolver.SolveDynamicObjectReference(rawInst.customObjectReference, 8484235 * (numberOfRerolls++), ParameterOwner.Pattern);
